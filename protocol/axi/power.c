...
/*! \file protocol/axi/power.c
 *  \brief Power Routines for AXi Series of Power Supplies
 */
#include "device.h"
#include "driver.h"
...
int
corsairlink_axi_power_supply_voltage(
...
int
corsairlink_axi_power_total_wattage(
