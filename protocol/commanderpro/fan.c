...
int corsairlink_commanderpro_set_fan_speed_pwm(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
            uint8_t sensor_index,
            uint8_t pwm)
{
            ...
            uint8_t *device_id)
{
	...
	commands[0] = 0x25;
    commands[1] = sensor_index;
    commands[2] = 0x00; // 0x00 = CP Temp Probe 1 .... 0x03 = CP Temp Probe 4, 0xff = External
...
int corsairlink_commanderpro_send_temperature_info(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
            uint8_t sensor_index,
            uint8_t temperature)
{
...
int corsairlink_commanderpro_set_fan_connection_mode(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
            uint8_t sensor_index,
            uint8_t mode)
{
