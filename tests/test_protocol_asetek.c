...
int
__wrap_corsairlink_asetek_write(
...
int
__wrap_corsairlink_asetek_read(
    struct libusb_device_handle* dev_handle, uint8_t endpoint, uint8_t* data, int length )
{
    check_expected( endpoint );
    check_expected( data );
...
/* tests */
void
test_corsairlink_asetek_firmware_id_failure( void** state )
{
    (void)state; /* unused */
    int ret;
...
void
test_corsairlink_asetek_firmware_id_success( void** state )
{
    (void)state; /* unused */
    int ret;
