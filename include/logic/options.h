...
static struct option long_options[] = {
    {"help", no_argument, 0, OPTION_HELP},       {"version", no_argument, 0, OPTION_VERSION},
    {"debug", no_argument, 0, OPTION_DEBUG},     {"dump", no_argument, 0, OPTION_DUMP},
    {"machine", no_argument, 0, OPTION_MACHINE}, {"device", required_argument, 0, OPTION_DEVICE},
    {"led", required_argument, 0, OPTION_LED},   {"fan", required_argument, 0, OPTION_FAN},
    {"pump", required_argument, 0, OPTION_PUMP}, {0, 0, 0, 0}};
...
enum
{
    ...
    SUBOPTION_LED_MODE,
    SUBOPTION_LED_STRIP_COUNT,
    SUBOPTION_LED_STRIP_TYPE,
    SUBOPTION_LED_SPEED,
    SUBOPTION_LED_DIRECTION,
    SUBOPTION_LED_CHANGE_STYLE,
